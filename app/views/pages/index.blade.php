	...
	<div class="header">
	   <div class="container">
		  <div class="header-text">
			<h1>DAW-PT</h1>
			<h2>La mejor opción para el fitness</h2>
			<p>DAW-PT el lugar donde encontrarás toda la información que necesitás para conseguir tus objetivos.</p>
			<div class="banner_btn">
				<a href="#menu">Continuar</a>
			</div>
		  </div>
	 	 ...
	 	 <div class="container">
			...
			<div class="row content-top">
				 ...
				 <div class="col-md-7 content_left_text">
				   <h3>DAW-PT</h3>
				   <p>La forma más rápida y económica de encontrar un entrenador personal. Disfruta de la experiencia y consigue los resultados experados.</p>
				 </div>
            </div>
		 </div>
		<!-- end content-top -->
		<div class="container">
		    <div class="row content-middle">
		      <!-- start content-middle -->
				 ...
				 <div class="col-md-4"><a href="puntua">
	 	    		<ul class="spinning">
